    ...
    <>
      <div className="home">
        ...
        <div className="home-film">
          <div className="name-film">Insider</div>
          <div className="about-film">2022 | Comedy horror | 1 Season</div>

          <div className="home-btn">
            <button className="home-btn__watch">Watch now</button>
            <button className="home-btn__favorites"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
